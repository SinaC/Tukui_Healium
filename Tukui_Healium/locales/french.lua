...
if GetLocale() == "frFR" then
	...
	L.INFO_SHOW = "Fen\195\170tres de raid affich\195\169es. Pour les cacher, utilisez %s toggle ou le menu"
	L.INFO_HIDE = "Fen\195\170tres de raid cach\195\169es. Pour les afficher, utilisez %s toggle ou le menu"
